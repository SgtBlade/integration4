  ...
  return useObserver(() => (
    ...
    <ul className={style.thievesList}>
        <li onClick={props.nextFunction} className={style.thievesList__item}>
            <img className={style.thievesList__item__image} width="187" height="210" src={"/assets/illustraties/uiltjeTutorial.svg"} />
            <p className={style.thievesList__item__text} style={{color: COLORS.redDark}}>Een uil</p>
        </li>

        <li onClick={props.nextFunction} className={style.thievesList__item}>
            <img className={style.thievesList__item__image} width="200" height="218" src={"/assets/illustraties/vosTutorial.svg"} />
            <p className={style.thievesList__item__text} style={{color: COLORS.orangeDark}}>Een vos</p>
        </li>

        <li onClick={props.nextFunction} className={style.thievesList__item}>
            <img className={style.thievesList__item__image} width="277" height="196" src={"/assets/illustraties/wasbeerTutorial.svg"} />
